...
//$meta['deflang'] = array('dirchoice','_dir' => DOKU_INC.'inc/lang/');
...
'Hungarian HU','Icelandic IS','Italian IT','Japanese JA','Korean KO','Latvian LV','Lithuanian LT','Macedonian MK','Norwegian NO','Persian FA','Polish PL','Portuguese PT','Romanian  RO','Russian RU','Serbian SR','Slovak SK','Spanish ES','Swedish SV','Taiwanese zh-tw','Turkish TR','Ukrainian UK'));
//$meta['deflang'] = array('multicheckbox','_choices'=>array('Albanian SQ','Arabic AR','Armenian HY','Basque EU','Bulgarian BG','Chinese ZH'));
