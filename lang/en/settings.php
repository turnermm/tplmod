...
$lang['acl_all'] = 'The ACL level required for access to the sitetoools and pagetools. Users with ACL levels equal to or less than this level will be barred from access to these tools';
